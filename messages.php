...
<?php
  $title = "{$noti->titleNoti()} Messages • Career Path";
  $keywords = "Career Path, Share and capture world's moments, share, capture, messages";
...
<script type="text/javascript">
  $(function(e){
    ...
    //       var n = new Notification('Career Path', {
    //         body: "Wlecome to Career Path!",
