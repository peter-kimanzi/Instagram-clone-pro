...
<?php
  $title = "{$noti->titleNoti()} Group not found • Career Path";
  $keywords = "eror, 404, document not found, webpage not found, Career Path, Share and capture world's moments";
  $desc = "There's been an error • Career Path";
?>
