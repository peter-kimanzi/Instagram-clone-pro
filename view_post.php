...
<?php
  $title = "{$noti->titleNoti()} Post by {$universal->GETsDetails($post_by, "username")} • Career Path";
  $keywords = "Career Path, Share and capture world's moments, share, capture, view post";
