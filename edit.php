...
<?php
  $title = "{$noti->titleNoti()} Edit profile (@".$universal->getUsernameFromSession().") • Career Path";
  $keywords = "Career Path, Share and capture world's moments, share, capture, home";
