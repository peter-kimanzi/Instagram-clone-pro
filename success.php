...
<?php
  $title = "Thanks for registering • Career Path";
...
<html>
  <head>
    ...
    <meta name="author" content="Career Path, Faiyaz Shaikh">
...
<div class="badshah">
  ...
  <div class="about_div inst success_div">
    ...
    <div class="">
      ...
      <span>Career Path is hosted freely, so you'll find it bit slow, because hosting company has allowed limited requests per minute.</span>
