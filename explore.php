...
<?php
  $title = "{$noti->titleNoti()} Explore Career Path • Share and capture world's moments";
  $keywords = "Career Path, Share and capture world's moments, share, capture, explore";
