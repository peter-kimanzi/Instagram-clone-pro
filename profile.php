...
<?php
  $title = "{$noti->titleNoti()} @{$universal->GETsDetails($get_id, "username")} ({$universal->GETsDetails($get_id, "firstname")} {$universal->GETsDetails($get_id, "surname")}) • Career Path";
  $keywords = "{$universal->GETsDetails($get_id, "username")}, {$universal->GETsDetails($get_id, "firstname")}, {$universal->GETsDetails($get_id, "surname")}, Career Path, Share and capture world's moments";
  $desc = "Connect with {$universal->GETsDetails($get_id, "username")}'s profile • Career Path";
?>
...
<div class="badshah">
  ...
  <?php
    if($universal->isLoggedIn() == false){
      echo "<div class='home_last_mssg private_last_mssg'><img src='". DIR ."/images/needs/largee.jpg'>
